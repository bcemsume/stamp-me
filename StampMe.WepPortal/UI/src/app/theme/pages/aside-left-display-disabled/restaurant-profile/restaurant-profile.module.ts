...
@NgModule({
    imports: [
        CommonModule, DxPopupModule, RouterModule.forChild(routes), MultiselectDropdownModule, LayoutModule, DxDataGridModule, FormsModule, ReactiveFormsModule, ToasterModule, NouisliderModule,
        DxSelectBoxModule, AgmCoreModule.forRoot({
