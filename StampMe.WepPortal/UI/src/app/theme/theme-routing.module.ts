...
const routes: Routes = [
    {
        ...
        "children": [
            ...
            {
                "path": "admin",
                "loadChildren": ".\/pages\/aside-left-display-disabled\/admin\/admin.module#AdminModule"
            },
            {
                "path": "inner",
            ...
            {
                "path": "profile",
                "loadChildren": ".\/pages\/aside-left-display-disabled\/restaurant-profile\/restaurant-profile.module#RestaurantProfileModule"
            },
            {
                "path": "404",
